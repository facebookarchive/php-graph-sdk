...
class RequestUrlEncodedTest extends TestCase
{
    public function testCanProperlyEncodeAnArrayOfParams(): void
    {
        ...
        static::assertEquals('foo=bar&scawy_vawues=%40FooBar+is+a+real+twitter+handle.', $body);
    }
