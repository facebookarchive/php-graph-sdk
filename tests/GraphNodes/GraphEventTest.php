...
class GraphEventTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $dataFromGraph = [
            'end_time' => '2015-04-14T11:00:00+0300',
            'start_time' => '2015-04-14T11:00:00+0300',
            'updated_time' => '2015-04-14T11:00:00+0300',
        ];
        ...
        $this->assertInstanceOf('DateTime', $end_time);
        $start_time = $graphObject->getStartTime();
        $this->assertInstanceOf('DateTime', $start_time);
        $updated_time = $graphObject->getUpdatedTime();
        $this->assertInstanceOf('DateTime', $updated_time);
    }
