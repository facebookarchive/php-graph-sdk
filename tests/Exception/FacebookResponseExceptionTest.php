...
class FacebookResponseExceptionTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testAuthenticationExceptions()
    {
        ...
        $this->assertInstanceOf('Facebook\Exception\FacebookAuthenticationException', $exception->getPrevious());
    ...
    public function testServerExceptions()
    {
        ...
        $exception = FacebookResponseException::create($response);
        $this->assertInstanceOf('Facebook\Exception\FacebookServerException', $exception->getPrevious());
    ...
    public function testThrottleExceptions()
    {
        ...
        $response = new FacebookResponse($this->request, json_encode($params), 401);
        $exception = FacebookResponseException::create($response);
        $this->assertInstanceOf('Facebook\Exception\FacebookThrottleException', $exception->getPrevious());
    ...
    public function testAuthorizationExceptions()
    {
        ...
        $response = new FacebookResponse($this->request, json_encode($params), 401);
        $exception = FacebookResponseException::create($response);
        $this->assertInstanceOf('Facebook\Exception\FacebookAuthorizationException', $exception->getPrevious());
    ...
    public function testClientExceptions()
    {
        ...
        $response = new FacebookResponse($this->request, json_encode($params), 401);
        $exception = FacebookResponseException::create($response);
        $this->assertInstanceOf('Facebook\Exception\FacebookClientException', $exception->getPrevious());
    ...
    public function testOtherException()
    {
        ...
        $exception = FacebookResponseException::create($response);
        $this->assertInstanceOf('Facebook\Exception\FacebookOtherException', $exception->getPrevious());
