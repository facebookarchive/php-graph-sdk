...
class GraphNodeFactoryTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        GraphNodeFactory::validateSubclass('\Facebook\GraphNode\GraphNode');
        GraphNodeFactory::validateSubclass('\Facebook\GraphNode\GraphAlbum');
    ...
    public function testAnUnknownGraphNodeWillBeCastAsAGenericGraphNode()
    {
        ...
        $this->assertInstanceOf('\Facebook\Tests\Fixtures\MyFooGraphNode', $mySubClassObject);
        $this->assertInstanceOf('\Facebook\GraphNode\GraphNode', $unknownObject);
    ...
    public function testAListFromGraphWillBeCastAsAGraphEdge()
    {
        ...
        $this->assertInstanceOf('\Facebook\GraphNode\GraphEdge', $graphEdge);
        $this->assertEquals([
            'id' => '123',
            'name' => 'Foo McBar',
            'link' => 'http://facebook/foo',
    ...
    public function testAGraphEdgeWillBeCastRecursively()
    {
        ...
        $this->assertInstanceOf('\Facebook\GraphNode\GraphEdge', $graphNode);

        // Story
        $storyObject = $graphNode[0];
        $this->assertInstanceOf('\Facebook\GraphNode\GraphNode', $storyObject['from']);
        $this->assertInstanceOf('\Facebook\GraphNode\GraphEdge', $storyObject['likes']);
        $this->assertInstanceOf('\Facebook\GraphNode\GraphEdge', $storyObject['comments']);

        // Story Comments
        $storyComments = $storyObject['comments'];
        $firstStoryComment = $storyComments[0];
        $this->assertInstanceOf('\Facebook\GraphNode\GraphNode', $firstStoryComment['from']);

        // Message
        $messageObject = $graphNode[1];
        $this->assertInstanceOf('\Facebook\GraphNode\GraphEdge', $messageObject['to']);
        $toUsers = $messageObject['to'];
        $this->assertInstanceOf('\Facebook\GraphNode\GraphNode', $toUsers[0]);
    }
