...
class GraphUserTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testBirthdaysGetCastToBirthday()
    {
        ...
        $this->assertInstanceOf('\\Facebook\\GraphNode\\Birthday', $birthday);
    ...
    public function testPagePropertiesWillGetCastAsGraphPageObjects()
    {
        ...
        $this->assertInstanceOf('\\Facebook\\GraphNode\\GraphPage', $hometown);
        $this->assertInstanceOf('\\Facebook\\GraphNode\\GraphPage', $location);
    }
    ...
    public function testUserPropertiesWillGetCastAsGraphUserObjects()
    {
        ...
        $this->assertInstanceOf('\\Facebook\\GraphNode\\GraphUser', $significantOther);
    }
    ...
    public function testPicturePropertiesWillGetCastAsGraphPictureObjects()
    {
        ...
        $this->assertInstanceOf('\\Facebook\\GraphNode\\GraphPicture', $Picture);
