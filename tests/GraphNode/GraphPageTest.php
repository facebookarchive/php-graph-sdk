...
class GraphPageTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testPagePropertiesReturnGraphPageObjects()
    {
        ...
        $this->assertInstanceOf('\\Facebook\\GraphNode\\GraphPage', $bestPage);
        $this->assertInstanceOf('\\Facebook\\GraphNode\\GraphPage', $globalBrandParentPage);
    }
    ...
    public function testLocationPropertyWillGetCastAsGraphLocationObject()
    {
        ...
        $this->assertInstanceOf('\\Facebook\\GraphNode\\GraphLocation', $location);
    }
}
