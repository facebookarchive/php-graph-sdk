...
To instantiate a new `Facebook\SignedRequest` entity, pass the [`Facebook\FacebookApp`](/docs/reference/FacebookApp.md) entity and raw signed request to the constructor.
...
Usually `Facebook\SignedRequest` entities are obtained using one of the [helpers](/docs/reference.md#helpers).
