...
This repository contains the open source PHP SDK which provides a rich interface for the Facebook Platform.

This repository contains the open source PHP SDK that allows you to access Facebook Platform from your PHP app.
Except as otherwise noted, the Facebook PHP SDK is licensed under the
