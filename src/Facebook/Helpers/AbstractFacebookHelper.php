...
abstract class AbstractFacebookHelper
{
   ...
   */
  public static function create($appId, $appSecret, FacebookHttpClientInterface $httpClient = null, $graphVersion = 'v2.0', $useSecretProof = true, $useBeta = false)
  {
    return new static(
      new FacebookApplication($appId, $appSecret),
      new FacebookGraphApi($httpClient, $graphVersion, $useSecretProof, $useBeta)
    );
  }
