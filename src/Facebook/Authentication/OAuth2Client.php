...
class OAuth2Client
{
     ...
     * @throws FacebookSDKException
     */
    public function getCodeFromLongLivedAccessToken($accessToken, string $redirectUri = ''): AccessToken
    {
        $params = [
            'redirect_uri' => $redirectUri,
        ];
     ...
     */
    protected function sendRequestWithClientParams(string $endpoint, array $params, $accessToken = null)
    {
